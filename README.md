...
The usual story – download the main file and add `include "path/to/wp-pagination.php"` in your `functions.php` file.
...
* **`the_pagination()`** directly displays the pagination.

Both accept the same arguments (more on that in the next chapter), with the exeption that, in `the_pagination()` function, you can pass a pagination array as the first argument.
...
// ( http://mysite.com/category/news/page/5/ )
...
(
    ...
    [2] => stdClass Object
        (
            [text] => 2
            [class] => 
            [link] => http://mysite.com/category/news/page/2/
        )
    ...
    [3] => stdClass Object
        (
            [text] => 3
            [class] => 
            [link] => http://mysite.com/category/news/page/3/
        )
    ...
    [7] => stdClass Object
        (
            [text] => 7
            [class] => 
            [link] => http://mysite.com/category/news/page/7/
        )
    ...
    [8] => stdClass Object
        (
            [text] => 8
            [class] => 
            [link] => http://mysite.com/category/news/page/8/
        )
...
<nav class="pagination" role="navigation">
  <ul>
    <li class="count"><span><span>Page</span> <span class="current_page">5</span> <span>of</span> <span class="total_pages">12</span></li>
